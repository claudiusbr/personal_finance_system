...
This time it was felt that Fowler's (\citeyear[][Ch.~6.4]{fowler1997analysis})
\emph{Memo Account} pattern would be useful for this case. Designing this
requirement with this pattern would ensure that, whenever the user created a
category which was deemed taxable, a portion of the income would be posted to
the tax account. It is also necessary to remember whether income has already
been deducted or if it relates to the gross amount, so this will have to be
taken into consideration.

\textbf{TODO: find the proper design pattern for this: a enum which keeps track of the tax situation of each category -- are they income deducted at source, or tax deductible expenditure?}
