...
\begin{figure}[ht!]
  \begin{center}
    \includegraphics[width=14cm]{./contents/img/Comm_Diagram_-_Visualise_Categorised_Summary.png}
  \end{center}
...
Accounting Practices (UK GAAP), where taxation is centralised and happens in
tiers.
