...
presentation layer. One of the reasons why it was chosen was that, as with many
other GUI packages, it already comes with an implementation of the
\emph{Observer Design Pattern} (\cite[][]{gamma1995design}) in its capacity to
react to events (\cite[][p.~5]{maier2009scala};
