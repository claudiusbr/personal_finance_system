...
package was used for building most aspects of the
presentation layer. The package consists of Scala wrappers for the Java Swing
package, and one of the reasons why it was chosen was that, as with many other
GUI packages, it already comes with an implementation of the \emph{Observer
Design Pattern} (\cite[][]{gamma1995design}) in its capacity to react to events
