...
HSQLDB was chosen as a test with the condition that, if any major problems were
found, others would be considered. As no major problems were encountered, the
portable choice remained, but not enough research was made into the other
DBMS's to determine if this was the best one.
