...
what is ``taxed at 0\%''. As indicated by Figure
\ref{fig:Wireframe.EstimateTax}, for the purposes of the estimation provided by
the requirements in this project, it was decided that this distinction would be
ignored, and that the user can simply have a choice to use one of the dynamic
boxes on \emph{Normal Taxation Rates} to indicate a tax free allowance.
