...
(\textbf{TODO:} \textsc{since the requirements on the next three paragraphs
were never implemented, move them to an appendix})
...
deducted at a different rate and before the base tax. (\textbf{TODO:}
